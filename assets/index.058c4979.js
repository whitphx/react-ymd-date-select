var O=Object.defineProperty;var w=Object.getOwnPropertySymbols;var V=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable;var D=(a,r,o)=>r in a?O(a,r,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[r]=o,u=(a,r)=>{for(var o in r||(r={}))V.call(r,o)&&D(a,o,r[o]);if(w)for(var o of w(r))P.call(r,o)&&D(a,o,r[o]);return a};import"./modulepreload-polyfill.b7f2da20.js";import{n as i,r as f,j as t,a as c,F as z,S,b as L,L as I,R as E,E as T,c as U,u as Y,d as n,e as l,f as j,g as B,h as $,i as A,C as N}from"./vendor.5ce835ef.js";import"./DateSelect.441a108e.js";import{g as q,u as W}from"./use-date-select.61b1bfac.js";import{C as p}from"./index.69b76d26.js";import"./DateSelect.d9ead660.js";import"./DateSelect.a3d90621.js";const G=i.code`
...
`,ie=i.div`
  ...
  max-width: 360px;
  margin: 16px auto 0;
`;function le(){return c(K,{children:[c(Q,{children:[t(Z,{children:"react-ymd-date-select"}),t(ee,{children:"Hooks and components for Y-M-D dropdowns with React"})]}),c(ne,{children:[c(te,{children:[t(F,{children:t(k,{children:"npm install react-ymd-date-select"})}),t(F,{children:t(k,{children:"yarn add react-ymd-date-select"})})]}),t(ie,{children:t(_,{})})]}),t(ae,{children:t(oe,{children:t(re,{href:"https://github.com/whitphx/react-ymd-date-select",isExternal:!0,children:"See on GitHub"})})})]})}const de=i.div`
  margin: 32px auto;
  max-width: 960px;
  padding: 0 16px;
`;function ce(a){const r=a.children;if(!E.isValidElement(r))return t("pre",u({},a));const{className:o}=r.props,e=o==null?void 0:o.replace(/language-/,""),s=r.props.children.trim();return e==="jsx"||e==="tsx"?t(p,{initialCode:s,language:e}):t("pre",{children:t("code",{children:r})})}const se=i.code`
  margin: 0 2px;
  padding: 1px 4px;
  border-radius: 5px;
...
`;const H=i.button`
  ...
  font-size: 1rem;
  padding: 0.4rem;
`;function M({code:a,language:r,children:o}){const[e,{on:s,off:d}]=Y();return c(xe,{children:[t(we,{children:o}),!e&&t(H,{onClick:s,children:"Show code"}),e&&t(be,{children:t(ye,{value:a,language:r,readOnly:!0})}),e&&t(H,{onClick:d,children:"Hide code"})]})}const De=i.div`
  display: flex;
  width: 100%;
...
`;function ke(){return t(b,{src:"./website/components/preset-samples/samples/vanilla/index.html"})}function Fe(){return c(De,{children:[c(R,{children:[t(x,{children:"Chakra UI"}),t(M,{code:ve,language:"tsx",children:t(b,{src:"./website/components/preset-samples/samples/chakra-ui/index.html"})})]}),c(R,{children:[t(x,{children:"Material UI"}),t(M,{code:Ce,language:"tsx",children:t(b,{src:"./website/components/preset-samples/samples/mui/index.html"})})]})]})}var He=`import { useState } from "react";
...
export default Sample;
`,Me=`import { useForm, Controller } from "react-hook-form";
...
export default Sample;
`;function ze(a={}){const{wrapper:r}=a.components||{};return r?n(r,Object.assign({},a,{children:n(o,{})})):o();function o(){const e=Object.assign({h2:"h2",p:"p",code:"code",a:"a",h3:"h3"},a.components);return l(j,{children:[n(e.h2,{children:"Presets"}),`
...
`,l(e.p,{children:["This example shows how to pass the ",n(e.code,{children:"ref"})," to the preset component and how to integrate it with React Hook Form, which uses the ",n(e.code,{children:"ref"}),"."]})]})}}function Le(){return c(B,{children:[t(le,{}),t(de,{children:t(ze,{components:ge})})]})}const Te=$({styles:{global:{"*, *::before, &::after":{borderColor:null,wordWrap:null},html:{lineHeight:1.5},body:{position:"relative",minHeight:"100%",fontFeatureSettings:"kern"},"*, *::before, *::after":{boxSizing:"border-box"},"body, blockquote, dl, dd, h1, h2, h3, h4, h5, h6, hr, figure, p, pre":{margin:0}}}}),Ue=document.getElementById("root"),Ye=A(Ue);Ye.render(t(E.StrictMode,{children:t(N,{resetCSS:!1,theme:Te,children:t(Le,{})})}));
