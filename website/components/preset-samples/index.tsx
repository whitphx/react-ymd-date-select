...
export function VanillaSample() {
  return (
    <IFrame src="./website/components/preset-samples/samples/vanilla/index.html" />
  );
}
    ...
    <SideBySideContainer>
      <SampleContainer>
        ...
        <CollapseCodeBlock code={ChakraSampleCode} language="tsx">
          <IFrame src="./website/components/preset-samples/samples/chakra-ui/index.html" />
        </CollapseCodeBlock>
      </SampleContainer>
      <SampleContainer>
        <H3>Material UI</H3>
        <CollapseCodeBlock code={MuiSampleCode} language="tsx">
          <IFrame src="./website/components/preset-samples/samples/mui/index.html" />
        </CollapseCodeBlock>
      </SampleContainer>
    </SideBySideContainer>
  );
